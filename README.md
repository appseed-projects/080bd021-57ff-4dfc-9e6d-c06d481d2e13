...
- Timestamp: `2022-06-13 21:22`
- Build ID: `080bd021-57ff-4dfc-9e6d-c06d481d2e13`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/080bd021-57ff-4dfc-9e6d-c06d481d2e13.git
$ cd 080bd021-57ff-4dfc-9e6d-c06d481d2e13
```
